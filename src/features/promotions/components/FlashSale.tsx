  ...
  return (
    <div className="bg-gradient-to-br from-gray-50 to-gray-100 py-8 sm:py-12 md:py-16 lg:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="inline-flex items-center gap-2 sm:gap-3 bg-black text-white px-4 sm:px-6 md:px-8 py-2 sm:py-2.5 md:py-3 rounded-full mb-4 sm:mb-6 md:mb-8">
          <span className="text-[10px] sm:text-xs md:text-sm font-semibold tracking-wider">LIMITED TIME</span>
          <span className="text-base sm:text-lg md:text-xl font-bold">50% OFF</span>
        </div>
